...
export const SetupWizard: React.FC = () => {
  ...
  const { entrepreneurProfile, setOnboardingComplete } = useIdentityStore();
  const isSeeded = store.seededFromIdentity;
        ...
        <div className="card-pro p-7 md:p-9 space-y-6 overflow-hidden relative">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-accent/[0.06]">
            <div className="flex items-center gap-3">
              ...
              <div>
              <h2 className="text-base font-bold text-ink-900" style={{ fontFamily: SG }}>Shape Your Startup</h2>
                <p className="text-[10px] text-ink-300 font-semibold uppercase tracking-wider mt-0.5">
                  {entrepreneurProfile ? `Powered by your ${entrepreneurProfile.archetype} identity` : 'Configure your workspace'}
                </p>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  {isSeeded && (
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider"
                      ...
                      <span>Pre-filled from your Identity Discovery — feel free to refine</span>
                    </div>
                  )}
                  <div>
